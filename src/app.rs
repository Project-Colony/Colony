//! The `App` shell: boot, root view, subscriptions and theme.
//!
//! Kept out of `main.rs` so the crate root stays a list of modules and an entry
//! point. The message handling lives in [`crate::update`], the widgets in
//! [`crate::ui`].
...
use crate::{download, github, i18n, oauth, scan, sections, state, ui};
